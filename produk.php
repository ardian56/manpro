        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <div class="thumbnail"><img src="admin/foto produk/<?php echo $perproduk['foto'];?>" alt="" width="150px">
            <div class="caption">
              ...
              <p>Jenis Produk : <?php echo $perproduk['jenis'];?></p>
              <p>Stok Produk : <?php echo $perproduk['stok'];?></p>
              <p>Kondisi Produk : <?php echo $perproduk['kondisi'];?></p>
              <p>Ukuran Produk : <?php echo $perproduk['ukuran'];?></p>
              <p>Warna Produk : <?php echo $perproduk['warna'];?></p>
              <h3>Harga : Rp. <?php echo number_format($perproduk['harga']);?></h3>
              <a href="beli.php?id=<?php echo  $perproduk['id']; ?>">
                <button type="submit" class="btn btn-primary">Beli</button></a>
          </div>
          </div>
        </div>
        <?php }?>
