...
<!-- isi -->
	   <section id="main-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Daftar Pesan</li>						  	
					</ol>
				</div>
			</div>              
            <div class="row">
        ...
        while($tamu = mysqli_fetch_array($query)){
            ...
            echo "<td>".$tamu['nomer']."</td>";
            echo "<td>".$tamu['email']."</td>";
            echo "<td>".$tamu['alamat']."</td>";
            echo "<td>".$tamu['pesan']."</td>";

            echo "<td>";
            echo "<a class='btn btn-danger' href='hapus.php?id=".$tamu['id']."' data-toggle='tooltip' title='Hapus!'><i class='icon_close_alt2'></i></a>";
            echo "</td>";
            echo "</tr>";
        }
        ?>
